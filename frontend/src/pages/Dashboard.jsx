...
const employees = [
  { name: 'Nisha Kapoor', title: 'Product Designer', department: 'Design', status: 'Present' },
  { name: 'Kabir Shah', title: 'Software Engineer', department: 'Engineering', status: 'On Leave' },
  { name: 'Meera Iyer', title: 'Finance Associate', department: 'Finance', status: 'Absent' },
  { name: 'Rohan Das', title: 'People Partner', department: 'People', status: 'Present' },
]
...
function AdminDashboard() {
  return <>
    ...
    <div className="dashboard-columns">
      <section className="dashboard-card"><div className="card-heading"><h2>Employee overview</h2><Link className="card-link" to="/employees">View all employees →</Link></div><div className="employee-list">{employees.map((employee) => <EmployeeCard key={employee.name} employee={employee} />)}</div></section>
